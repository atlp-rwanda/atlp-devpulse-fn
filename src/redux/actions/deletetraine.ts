        ...
        .then((res) => {
          if (res.data.data)
            dispatch({
              ...
              message: res.data.data.deleteTrainee.email,
            });
          if (res.data.errors) {
            var mess;
  ...
  return async (dispatch: Dispatch<softAction>) => {
    ...
    try {
      await axios
        ...
        .then((res) => {
          const bbb =
            res.data.data.softdeleteTrainee.email +
            " " +
            res.data.data.softdeleteTrainee.firstname;
          if (res.data.data)
            dispatch({
        ...
        .then((res) => {
          if (res.data.data)
            dispatch({
              ...
              data: res.data.data.getAllTrainees,
            });
          if (res.data.errors) {
            var mess;
            res.data.errors.map((b: any) => {
