                  ...
                  {headerGroups.map((headerGroup) => (
                    <tr className={headerGroup.getHeaderGroupProps()}>
                      {headerGroup.headers.map((column) => (
                        <th
                          className="p-6 border-b-2 border-gray-200 bg-gray-100 white:bg-dark-tertiary text-left text-xs font-semibold text-gray-600 dark:text- uppercase tracking-wider"
                  ...
                  {page.map((row) => {
                    ...
                    return (
                      <tr className={` ${rowTheme}} `} {...row.getRowProps()}>
                        {row.cells.map((cell) => (
                          <td
                            className="p-6 border-b border-gray-200 dark:border-dark-tertiary text-sm"
                            {...cell.getCellProps()}
                          >
                            {cell.render("Cell")}
                          </td>
