    ...
    <div className='grid grid-cols-2 gap-1 pt-5 ml-20 pb-20'>
      <div className='space-y-8'>
        ...
        <div className='space-y-5 w-2/3'>
          <label htmlFor="applicationPost" className={isDarkMode ? 'text-white' : 'text-gray-800'}>How did you find the post for this application?</label>
        ...
        <div className='space-y-5 w-2/3'>
          <label htmlFor="andelaPrograms" className={isDarkMode ? 'text-white' : 'text-gray-800'}>Did you participate in (and complete) any of the Andela Rwanda affiliated programs below?</label>
      ...
      <div className='space-y-8'>
        <div className='flex flex-col space-y-5 w-2/3'>
          <label htmlFor="understandTraining" className={isDarkMode ? 'text-white' : 'text-gray-800'}>Do you understand that the Andela Technical Leadership Program is an unpaid training Program?</label>
          <div>
            <input 
              type="radio" 
        ...
        <div className='flex flex-col space-y-5 w-2/3'>
          <label htmlFor="haveLaptop" className={isDarkMode ? 'text-white' : 'text-gray-800'}>If selected, do you have a laptop that you can use in the program?</label>
          <div>
            <input 
              type="radio" 
              name="haveLaptop" 
