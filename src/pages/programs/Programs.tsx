...
const Programs = (props: any) => {
  const { createProgramStates, fetchProgramStates } = props;
  ...
  // const fetchProgramStates = useAppSelector((state) => state.fetchPrograms);
                ...
                <div className="bg-white  dark:bg-dark-bg shadow-lg px-5 py-8 rounded-md w-[100%] mx-auto lg:w-[80%] lg:ml-60 mb-10">
                  <div>
                    <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                      <div className="hidden md_:inline-block w-full h-[55vh] lg:min-w-full shadow rounded-lg overflow-y-hidden">
                      ...
                      >
                        ...
                        <button
                          ...
                          disabled={
                            page >=
                            Math.ceil(
                              fetchProgramStates?.data?.length / itemsPerPage
                            ) -
                              1
                          }
                        >
