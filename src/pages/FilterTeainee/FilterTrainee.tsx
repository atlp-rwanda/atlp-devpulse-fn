...
const FilterTrainee = (props: any) => {
    ...
    const COLS = [
        ...
        },
        {
            ...
            Cell: ({ row }: any) => {
                return (
                    <select defaultValue={""} id="status" className="dark:text-[#dbdee6] border bg-row-gray dark:bg-[#293647] border-solid border-bdr dark:border-cg dark:border-opacity-5 shadow-sm px-4 py-4px rounded-bt-rd focus:outline-none sm:text-sm">
                        ...
                        <div className="flex items-center mb-6 semi-sm:flex-wrap">
                            <div className=" searchInputs relative block">
                                <span className="absolute inset-y-0 left-0 flex items-center pl-2">
                                    <svg className="h-5 w-5 fill-slate-300 text-cg dark:text-[#dbdee6] cursor-pointer" onClick={clearInpunt} viewBox="-6 -6 20 20">
                                        {enteredWord === "" ? (
                                ...
                                <input onChange={(e) => setEnteredWord(e.target.value)} className="dark:text-ltb block bg-row-gray dark:bg-[#293647] w-50 border border-bdr dark:border-cg dark:border-opacity-5 rounded-bt-rd mt-2 py-2 pl-9 pr-4 focus:outline-none sm:text-sm" value={enteredWord} placeholder="Search" type="text" name="search" />
                            </div>
                                    ...
                                    <tbody {...getTableBodyProps()}>
                                        {
                                            nonDeletedTrainee.length !== 0 ? (
                                                ...
                                                <tr>
                                                    <td></td><td></td>
                                                    <td className="float-right text-fb p-5 font-normal text-stone-500 dark:text-stone-400">No data </td>
                                                    <td></td><td></td>
                                                </tr>
                                            )
                                        }
