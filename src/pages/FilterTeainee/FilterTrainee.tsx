                ...
                <div className="flex items-center">
                    <label className="relative block ">
                        ...
                        <span className="absolute inset-y-0 left-0 flex items-center pl-2">
                            <svg className="h-5 w-5 fill-slate-300 text-cg" viewBox="-6 -6 20 20"><AiOutlineSearch /></svg>
                        </span>
                        <input className="block bg-row-gray w-50 border border-bdr rounded-bt-rd mt-2 py-2 pl-9 pr-4 focus:outline-none sm:text-sm" placeholder="Search " type="text" name="search" />
                    </label>
                    ...
                    <table className="w-full text-sm text-left text-button-color">
                        <thead className="text-button-color bg-row-gray">
                            <tr className="border-b border-bdr">
                                <th scope="col" className="p-4">
                                    <div className="flex items-center">
                                        <input id="checkbox-all-search" type="checkbox" className="w-4 h-4 text-button-color bg-gray rounded border-gray-300 focus:ring-gray dark:focus:ring-cg dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                        ...
                        <tbody>
                            <tr className="odd:bg-white even:bg-row-gray hover:bg-gray-50">
                                ...
                                <th scope="row" className="text-fb py-1 px-6 font-normal text-button-color whitespace-nowrap">
                                    Ange doe
                                </th>
                            ...
                            <tr className="odd:bg-white even:bg-row-gray hover:bg-gray-50">
                                <td className="p-4 w-4">
                                    <div className="flex items-center">
                                        <input id="checkbox-table-search-2" type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 focus:ring-2" />
                                ...
                                <td className="py-1 px-6">
                                <select id="status" className="border bg-row-gray border-solid border-bdr shadow-sm px-4 py-4px rounded-bt-rd focus:outline-none ">
                                    <option selected >Select value</option>
                                    <option value="passed">Passed</option>
                                    <option value="failed">Failed</option>
                                    <option value="religated">Religated</option>
                            ...
                            <tr className="odd:bg-white even:bg-row-gray hover:bg-gray-50">
                                ...
                                <td scope="row" className="text-fb py-1 px-6 font-normal text-button-color whitespace-nowrap">
                                    Aston martin
                                </td>
                                <td className="text-fb py-1 px-6 font-normal text-button-color">
                                    jaston@gmail.com
